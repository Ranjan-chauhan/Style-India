  ...
  return (
    <div className="bg-white lg:px-10">
      <div className="pt-6">
        ...
        <div className="grid grid-col-1 lg:grid-cols-2 pt-6 w-11/12 gap-x-12 gap-y-10   ">
          {/* Image gallery */}
          <div className="flex flex-col items-center">
            ...
            <div className=" flex flex-wrap space-x-3.5 justify-center">
              {product.images.map((item, index) => (
                <div
                  className="aspect-h-2 aspect-w-3 mt-2 overflow-hidden rounded-lg max-w-[6rem] max-h-[6rem]"
                  key={index}
                >
                  <img
                    src={item.src}
        ...
        {/* Similar Product */}
        <div className="pt-10">
        <h1 className="p-3 text-xl font-bold">Similar Product</h1>
        <div className="flex flex-wrap space-x-5 space-y-5 border items-center justify-center h-auto w-auto ">
